...
import { DS1, DS2, DS3 } from '../assets/data/CDCSampleData';
...
const CDCCanvas: FC = (): ReactElement => {
    ...
    // const [maxDCM, setMaxDCM] = useState(0.57)
    // const [minDCM, setMinDCM] = useState(0.006)
    ...
    // var sort = resultData.sort(function (a, b) {
    //     return a[2] - b[2]
    // })
    ...
    return (
        <div className='CDC-canvas'>
            ...
            <div className='dataset-choice'>
                ...
                />
                <span style={{ marginLeft: '10px' }}>Dataset</span>
            </div>
            <div className='k'>
                <Space>
            ...
            <div className='legend3' style={{ display: legend3 }}>
                <div>
                    ...
                    <img style={{ marginLeft: 26 }} src={require('../assets/images/introduction-images/closest distance.png')} width='37' alt='closest distance' />points to the nearest internal point
                </div>
            </div>
