        ...
        <Layout className="site-layout-background introduction" style={{ padding: '20px 14px', minHeight: 542 }}> {/* heigh: '100%' */}
            <Affix offsetTop={-50}>
                <div className="navigation" style={{ position: 'absolute', top: 150 }}>
                    ...
                    <div style={{ padding: '5px 0 0 5px' }}>
                        <a onClick={() => { scrollToAnchor('background') }}>Background</a>
                    </div>
                    <div style={{ padding: '5px 0 0 5px' }}>
                        <a onClick={() => { scrollToAnchor('methods') }}>Methods</a>
                    </div>
                    <ul>
                        <li>
                        ...
                        <li>
                            <a onClick={() => { scrollToAnchor('distance') }}>internal points connection</a>
                        </li>
                        <li>
                            <a onClick={() => { scrollToAnchor('parameter') }}>parameter analysis</a>
                        </li>
                        <li>
                            <a onClick={() => { scrollToAnchor('DCM-high-dimensional') }}>DCM calculation in high-dimensional space</a>
                        </li>
                    </ul>
                </div>
            </Affix>
            <div className="introduction-box">
                ...
                <div>
                    <div id='interaction' style={{ backgroundColor: '#ecf2f5', margin: '30px 0 10px 0', padding: '0 0 0 20px', height: 40, width: 280, borderRadius: 20, borderBottomRightRadius: 20 }}>
                        <h2 style={{ lineHeight: 1.3 }}>Interaction</h2>
                    </div>
                    <CDCCanvas />
                </div>

                <div>
                    <div id='background' style={{ backgroundColor: '#ecf2f5', margin: '30px 0 10px 0', padding: '0 0 0 20px', height: 40, width: 280, borderRadius: 20, borderBottomRightRadius: 20 }}>
                ...
                <div>
                    <div id='methods' style={{ backgroundColor: '#ecf2f5', margin: '30px 0 10px 0', padding: '0 0 0 20px', height: 40, width: 280, borderRadius: 20, borderBottomRightRadius: 20 }}>
                    ...
                    <div id='distance'>
                        <h3>Reachable distance calculation and internal points connection </h3>
                        ...
                        <p>where `d(p_i,q_j)` is the distance between the two points `p_i` and `q_j` (Fig. e). Two <span className="keyword">internal points can be connected</span> as the same cluster if the following association rule is guaranteed:</p>
                    ...
                    <div id='DCM-high-dimensional'>
                        <h3>DCM calculation in high-dimensional space</h3>
